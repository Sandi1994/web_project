...
<!-- Sidebar/menu -->
<nav class="w3-sidebar w3-collapse w3-top w3-large w3-padding" style="z-index:3;width:300px;font-weight:bold;background-color:#623c77;" id="mySidebar"><br>
  <a href="javascript:void(0)" onclick="w3_close()" class="w3-button w3-hide-large w3-display-topleft" style="width:100%;font-size:22px">Close Menu</a>
  <div class="w3-container">
    <h3 class="w3-padding-64" style="color:white"><span>Welcome, <?php echo htmlspecialchars($username); ?></span></h3>
  </div>
  ...
  <?php if ($role === 'customer') { ?>
     <a href="Booking.php" class="w3-bar-item w3-button w3-hover-white">Customer</a>
    <a href="Booking.php" class="w3-bar-item w3-button w3-hover-white">Booking</a>
    <a href="help.php" class="w3-bar-item w3-button w3-hover-white">Help</a>
  <?php } ?>
